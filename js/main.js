...
var start = function() {
	...
	// CEREMONY
	var images = [];
	images.push(new image('brasserie', 'wedding', 'rehearsal dinner', '<span class=italic>(picture: Erqi and Scott at rehearsal dinner tasting at Brasserie)</span><br>Essex Inn, 2nd Floor, 800 S. Michigan Avenue<br>Chicago, IL 60605<br>Catered by Brasserie by LM, June 14, 2013, time TBA'));
  images.push(new image('church', 'wedding', 'ceremony', 'St. Therese Chinese Catholic Church<br>218 W Alexander St<br>Chicago, IL 60616<br>June 15, 2013, time TBA<br>*The only Chinese Catholic church in the Midwest!'));
	images.push(new image('cake', 'wedding', 'reception', '<span class=italic>(picture: wedding cake tasting at Cafe Selmarie!)</span><br>MingHin Cuisine, 2nd Floor, 2168 S. Archer Avenue<br>Chicago, IL 60616<br>June 15, 2013, time TBA<br>*Our favorite and most frequented restaurant in Chicago!'));
	...
	// WEDDING PARTY
	images.push(new image('diana', 'wedding_party', 'diana', '(maid of honor) How she knows Erqi: through high school in louisiana.<br>What she’s doing now: law student at Columbia.<br>Fun fact: she found Erqi’s wedding dress at a Thakoon sample sale in NYC and got to see the designer himself!'));
	
	images.push(new image('stephane', 'wedding_party', 'stephane', '(best man) How he knows scott: through Sigma Chi at MIT. Lived and worked with Scott in Chicago for 3 yrs.<br>What he’s doing now: working at DRW Trading in Chicago.<br>Fun fact: enjoys staying up all night to watch the sun rise from scenic viewpoints.'));
	
	images.push(new image('martha', 'wedding_party', 'martha', 'How she knows erqi: through French camp in Nova Scotia.<br>What she’s doing now: law student at LSU.<br>Fun fact: she spent a year in Sete, France.'));
	images.push(new image('cordelie', 'wedding_party', 'cordelie', 'How she knows Erqi: through medical school at UMich.<br>What she’s doing now: general surgery resident at UWashington.<br>Fun fact: she runs marathons.'));
	images.push(new image('lauren', 'wedding_party', 'lauren', 'How she knows Erqi: through undergrad at MIT.<br>What she’s doing now: artist and software programmer in Boston.<br>Fun fact: she runs marathons (she also made this site).'));
	images.push(new image('anna', 'wedding_party', 'anna', 'How she knows erqi: through her brother Scott.<br>What she’s doing now: senior at IU. <br>Fun fact: recently campaigned for Joe Donnelly.'));
	images.push(new image('katie', 'wedding_party', 'katie', 'How she knows Erqi: through her brother Scott.<br>What she’s doing now: works at Kranti, a women’s rights NGO in India.<br>Fun fact: former captain of the IU women’s vball team.'));
	images.push(new image('liz', 'wedding_party', 'liz', 'How she knows erqi: through her brother Scott.<br>What she’s doing now: post-doc at Stanford.<br>Fun fact: was a drummer in the band semi-formal.'));
	images.push(new image('emily', 'wedding_party', 'emily', 'How she knows Erqi: through her brother Scott.<br>What she’s doing now: sophomore at Purdue.<br>Fun fact: she is a very good whistler.'));
	
	images.push(new image('caine', 'wedding_party', 'caine', 'How he knows Scott: through sigma chi and volleyball team at MIT.<br>What he’s doing now: working for Microsoft in Seattle, WA.<br>Fun fact: he’s a connoisseur of fine Asian foods.'));
	images.push(new image('dan', 'wedding_party', 'dan', 'How he knows Scott: went to Cathedral High School with Scott.<br>What he’s doing now: studying permaculture near Eugene, OR.<br>Fun fact: interests include photography and lawn games.'));
	images.push(new image('doug', 'wedding_party', 'doug', 'How he knows Scott: through Sigma Chi at MIT.<br>What he’s doing now: preparing for medical school in Davis, CA with his fiancee Emily.<br>Fun fact: has the strength of two men.'));
	images.push(new image('joe', 'wedding_party', 'joe', 'How he knows Scott: through Sigma Chi at MIT.<br>What he’s doing now: rocket scientist in washington DC.<br>Fun fact: he once went an entire month eating only salad and bananas.'));
	...
	images.push(new image('dietary', 'faq', 'food restrictions?', 'There will be gluten-free and vegetarian options at rehearsal dinner and reception; there will also be an opportunity on the RSVP cards to let us know any additional other dietary restrictions you may have.'));
